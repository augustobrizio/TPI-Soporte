 ...
 *
 * Es un route handler y no el `opengraph-image.tsx` de la convencion por una
 * sola razon, medida: `ImageResponse` responde en chunks y **sin
 ...
 * celular salia la tarjeta grande y desde la compu no. Aca se materializa el
 * PNG y se declara el largo, como hace S3 con los flyers de las novedades,
 * que se ven bien en los dos lados.
 *
 * Lo demas son restricciones de Meta (ver `agent_docs/compartir_previews.md`):
 * cuadrada porque WhatsApp arma la tarjeta grande con imagenes cercanas al
 * cuadrado, y PNG chico porque el limite son 600 KB.
 */
...
export async function GET(
  ...
  // Satori exige `display: flex` explicito en todo div con mas de un hijo, y
  // cuenta los nodos de texto: sin eso la generacion entera falla en runtime.
